...
class AccommodationStock():
        ...
        def remove_accommodation(self, type):
                """
                Remove an accommodation unit to the store

                Parameters
                ----------
                type : str
                   the type of accommodation unit to remove
                """
...
def process_find_accommodation(env, c, accommodation_stock, service_mean, warm_up_time, service_dist):
        ...
        while c.proceed == True:
                ...
                time_in_accomm = time_in_accomm = np.random.exponential(service_mean[accomm_type])
